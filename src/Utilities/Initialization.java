...
public class Initialization {
    ...
    private static void initCarArray(List<Car> carArray) {
        ...
        carArray.add(new Car("Лада 2110", new Driver("Пихтин Сергей Егорович", "+79627498756"), "AM 145 M 163", false, true, Car.TYPE_OF_CLASS_ECONOMIC, Car.TYPE_OF_STATUS_FREE));
        ...
        carArray.add(new Car("Лада 2112", new Driver("Холмогоров Василий Сергеевич", "+79329351856"), "PP 359 M 163", false, true, Car.TYPE_OF_CLASS_ECONOMIC, Car.TYPE_OF_STATUS_FREE));
        ...
        carArray.add(new Car("Renault Logan", new Driver("Перепелкина Елена Степановна", "+79242965478"), "EM 279 T 163", true, true, Car.TYPE_OF_CLASS_ECONOMIC, Car.TYPE_OF_STATUS_FREE));
        carArray.add(new Car("Renault Duster", new Driver("Телегин Олег Михайлович", "+79456125465"), "KM 248 X 163", false, true, Car.TYPE_OF_CLASS_ECONOMIC, Car.TYPE_OF_STATUS_FREE));
